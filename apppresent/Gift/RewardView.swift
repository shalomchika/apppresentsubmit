...
class RewardView: knView {
    ...
    var datasource = [Shop]() { didSet { collectionView.reloadData() }}
...
class RewardCollectionCell: knCollectionCell {
    ...
    override func setupView() {
        ...
        bannerImageView.backgroundColor = .green
    }
}
...
// fri
// you need to finish data preparetion
//fill reward data


// public gift page
// privte gift page - maybe explain again to me later, I thought there was one page, different data
// create post
